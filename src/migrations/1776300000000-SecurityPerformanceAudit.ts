...
export class SecurityPerformanceAudit1776300000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "job" ALTER COLUMN "salary_min" TYPE numeric(15,2)`,
    );
    await queryRunner.query(
      `ALTER TABLE "job" ALTER COLUMN "salary_max" TYPE numeric(15,2)`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "job" ALTER COLUMN "salary_max" TYPE integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "job" ALTER COLUMN "salary_min" TYPE integer`,
    );
